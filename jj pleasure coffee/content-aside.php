...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="side-entry-header">
		<h4 class="side-entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'toolbox' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_date(); ?></a></h4>
	</header><!-- .entry-header -->
