...
function toolbox_setup() {
    ...
    $custom_header_support = array(
        ...
        'height' => apply_filters( 'sketchbook_header_image_height', 200 ),
        'flex-height' => true,
        'random-default' => true,
...
function toolbox_posted_on() {
	printf( __( '<span class="sep">Posted on </span><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s">%4$s</time></a><span class="byline"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'toolbox' ),
